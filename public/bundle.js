...
/***/ function(module, exports, __webpack_require__) {
	...
	riot.tag2('app', '<voter-component></voter-component>', '', '', function (opts) {});
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(1)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	riot.tag2('voter-component', '<div class="voter"> <i class="glyphicon glyphicon-menu-up {highlighted: myVote == 1}" onclick="{upVote}"></i> <span class="vote-count">{voteCount + myVote}</span> <i class="glyphicon glyphicon-menu-down {highlighted: myVote == -1}" onclick="{downVote}"></i> </div>', '', '', function (opts) {
	    var _this = this;
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../node_modules/css-loader/index.js!./voter.component.css", function() {
				var newContent = require("!!./../node_modules/css-loader/index.js!./voter.component.css");
